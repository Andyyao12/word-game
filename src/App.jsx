    ...
    <div style={S.root}>
      ...
      {screen === "category" && (
        <div style={S.page}>
          ...
          <div className="cc" style={{ ...S.allCard,
...
const S = {
  ...
  ruleBox:{ background:"white", borderRadius:22, padding:"18px 20px", width:"100%",
  ...
  ruleIcon:{ background:"#f1f5f9", borderRadius:50, width:26, height:26, display:"inline-flex",
  ...
  bigBtn:{ background:"linear-gradient(135deg,#7c3aed,#4f46e5)", color:"white", border:"none",
  ...
  ghost:{ background:"none", border:"none", color:"#94a3b8", fontSize:13, fontWeight:700,
    cursor:"pointer", fontFamily:"'Nunito',sans-serif", padding:"4px 0" },
  allCard:{ display:"flex", alignItems:"center", gap:14, width:"100%", borderRadius:22,
  ...
  catCard:{ borderRadius:18, padding:"14px 6px", textAlign:"center", cursor:"pointer",
    boxShadow:"0 4px 12px rgba(0,0,0,0.12)", transition:"transform .15s" },
  catName:{ fontWeight:900, fontSize:12, color:"white", marginTop:4 },
  // setup
  deckStatus:{ background:"white", borderRadius:16, padding:"14px 18px", width:"100%",
  ...
  resetBtn:{ background:"#f1f5f9", border:"none", borderRadius:10, padding:"8px 14px",
    fontSize:13, fontWeight:800, color:"#7c3aed", cursor:"pointer", fontFamily:"'Nunito',sans-serif",
    whiteSpace:"nowrap" },
  section:{ background:"white", borderRadius:18, padding:"16px 18px", width:"100%",
  ...
  optBtn:{ flex:1, border:"none", borderRadius:14, padding:"12px 6px", display:"flex",
  ...
  optBtnSq:{ flex:1, border:"none", borderRadius:12, padding:"11px 4px", fontSize:14,
  ...
  pill:(bg,col)=>({ background:bg, borderRadius:50, padding:"7px 14px", fontWeight:900,
  ...
  ghost2:{ position:"absolute", left:0, right:0, height:"88%", background:"rgba(148,163,184,0.22)",
    borderRadius:30, transformOrigin:"bottom center" },
  card:{ position:"relative", zIndex:3, width:"100%", borderRadius:30, padding:"36px 24px 28px",
  ...
  cardWord:{ fontSize:54, fontWeight:900, color:"white", letterSpacing:5,
  ...
  skipBig:{ flex:1, background:"white", border:"3px solid #fed7aa", borderRadius:20,
  ...
  okBig:{ flex:1, background:"linear-gradient(135deg,#22c55e,#16a34a)", border:"none",
  ...
  // result
  resCard:{ background:"white", borderRadius:26, padding:"24px 20px", width:"100%",
  ...
  stats:{ display:"flex", justifyContent:"space-around", padding:"14px 0",
  ...
  medal:{ fontSize:14, fontWeight:800, color:"#7c3aed", background:"#faf5ff",
    borderRadius:14, padding:"11px 14px" },
  history:{ background:"white", borderRadius:18, padding:"16px", width:"100%",
